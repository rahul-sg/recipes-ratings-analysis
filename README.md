    ...
    <section>
        ...
        <h2>Univariate Analysis</h2>
            ...
            <p>
                ...
                <!-- Embed Plotly plot using an img tag if it's saved as an image -->
                <iframe src="assets/univar2.html" alt="Steps Distribution" width="800" height="450" frameborder="0"></iframe>
            ...
            <p>
                ...
                <!-- Embed Plotly plot using an img tag if it's saved as an image -->
                <iframe src="assets/univar3.html" alt="Rating Distribution" width="800" height="450" frameborder="0"></iframe>
            ...
            <p>
                ...
                <!-- Embed Plotly plot using an img tag if it's saved as an image -->
                <iframe src="assets/univar4.html" alt="Average Rating Distribution" width="800" height="450" frameborder="0"></iframe>
